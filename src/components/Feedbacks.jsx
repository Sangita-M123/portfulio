...
const FeedbackCard = ({ index, testimonial, name, link, image }) => (
  <motion.div
      ...
      <div className="mt-7 flex justify-between items-center gap-1">
        <div className="flex-1 flex flex-col">
          ...
          <a
            ...
            className="mt-1 text-blue-500 text-[12px] underline"
          >
            View Coding Profile
          </a>
        </div>
    ...
    <div className="mt-12 bg-black-100 rounded-[20px]">
      <div className={`${style.padding} bg-tertiary rounded-2xl min-h-[300px]`}>
        <motion.div variants={textVariant()}>
          <p className={style.sectionSubText}>Coding Profiles.</p>
          <h2 className={style.sectionHeadText}>Problem Solving</h2>
        </motion.div>
      </div>
